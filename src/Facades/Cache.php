...
namespace Woox\WebmanCache\Facades;
...
use Woox\WebmanCache\CacheConfigRepository;
use Woox\WebmanCache\Macro\FlushPreventMacro;
use Woox\WebmanCache\Mock\LaravelApp;
...
class Cache
{
    ...
    {
        if (!static::$_instance) {
            (new FlushPreventMacro(config('plugin.woox.webman-cache.app.flush', [])))->macro();
