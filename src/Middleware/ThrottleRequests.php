...
use Woox\WebmanCache\Exceptions\ThrottleRequestsException;
use Woox\WebmanCache\Facades\RateLimiter as RateLimiterFacade;

/**
 * 参考：https://github.com/laravel/framework/blob/10.x/src/Illuminate/Routing/Middleware/ThrottleRequests.php
 */
class ThrottleRequests implements MiddlewareInterface
{
     ...
     */
    protected function buildException(Request $request, Limit $limit): \Throwable|Response|ThrottleRequestsException
    {
